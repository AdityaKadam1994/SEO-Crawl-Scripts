<?php
$urlinput = $_POST["urlinput"]; //taking urls from form
$url = explode(",", $urlinput); //for separating urls
$a = array();
if (isset($_POST['submit'])) {
	if (!empty($_POST['tag'])) {
		foreach ($_POST['tag'] as $tagData) {
			array_push($a, $tagData);
		}
	}
	...
	crawlPage($url, $a);
	// crawlPage([
	// 	"https://www.itimf.com/locate_advisor/east.aspx",
	// 	"https://www.itimf.com/locate_advisor/west.aspx",
	// 	"https://www.itimf.com/for-investors/faqs/ISIP"
	// ], ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'a', 'img', 'meta', 'link']);
}
